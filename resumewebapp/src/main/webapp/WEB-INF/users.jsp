...
<div class="mycontainer container">
    <div class="row">
        <div class="col-4">
            <%--@elvariable id="user" type="object"--%>
            <f:form action="usersm" method="GET" modelAttribute="user">
                ...
                <f:button class="btn btn-primary" style="margin-top: 5px" type="submit">Search</f:button>
            </f:form>
        </div>
    </div>
    <hr/>
                ...
                <tr>
                    ...
                    <td style="width: 5px">
                        <form action="userdetail" method="POST">
                            ...
                            <button class="btn btn-danger" name="action" value="delete" type="button"
                                    data-toggle="modal"
                                    data-target="#deleteModal" onclick="setIdForDelete(${u.id})">
