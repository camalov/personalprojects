...
import com.dao.operations.UserManager;
...
public class LoginScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fastLabel.setForeground(new java.awt.Color(0, 0, 0));
        ...
        modernLabel.setForeground(new java.awt.Color(0, 0, 0));
        ...
        comfortLabel.setForeground(new java.awt.Color(0, 0, 0));
        ...
        leftLayout.setForeground(new java.awt.Color(0, 0, 0));
        ...
        if (me == 1 && loginButtonEnable) {
            ...
            if (!userName.trim().equals("") && !password.trim().equals("")) {
                ...
                if (loginSuccess) {
                    ...
                    messageLabel3.setVisible(false);
                    setVisible(false);
                    DropdownSidebar mainPage = new DropdownSidebar();
