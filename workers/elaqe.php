  ...
  <div class="wrapper">
    <article class="col-1">
      <div class="indent-left">
        ...
        <form id="contact-form" action="nedmin/netting/emeliyyatlar.php" method="post" >
          <fieldset> <?php if ($_GET['operation']=='no') { ?>
          <h3 class="p1">Mesaj Göndərilmədi! Yenidən cəhd edin!</h3>
          <? } ?>
          ...
          <label><span class="text-form">Telefon:</span>
            <input type="number" name="nomre" maxlength="20">
          </label>
          <label><span class="text-form">Mövzu:</span>
            <input type="text" name="movzu" maxlength="50">
          </label>
          <div class="wrapper">
            <div class="text-form">Mesaj:</div>
            <div class="extra-wrap">
              <textarea type="text" name="mesaj" required=""></textarea>
            </div>
          </div>
          <br>
          <button class="button-2" style="margin-left:525px;" type="submit" name="contact_form">Göndər</button>
        </fieldset>
      </form>
