        ...
        <div id="page-wrapper">
            <div id="page-inner">
             ...
             <form  action="netting/emeliyyatlar.php" method="POST" enctype="multipart/form-data" >			         
                <div><img src="<?php echo $xeber_cek['xeber_sekilyolu']; ?>" class="fileupload-preview thumbnail" style="width: 200px; height: 150px; margin-left:25px; "></div>  
               <div class="col-md-12" >
            ...
            <div class="form-group col-md-4">
                 <a><input style="width:100%" class="btn btn-success" type="submit" name="xeber_movzu_deyis" value="Yadda saxla"></a>
            </div>
          </div>
