...
<?php 
  ...
  $xidmet_sorgula=mysql_query("select * from xidmetler where xidmet_id='".$xidmet_id."' ");
  $xidmet_cek=mysql_fetch_assoc($xidmet_sorgula);
?>
        ...
        <div id="page-wrapper">
             ...
             <div class="col-md-12"> 	       		
             	 <div  class="form-group col-md-6">
                 	 <label>Xidmət adı</label>
                    	<input class="form-control" type="text" name="xidmet_ad" required="" <?php if($_GET['saxlandi']=='ok'){ ?> value="<?php echo $xidmet_cek['xidmet_ad'] ?>" <?php } ?> placeholder="Yeni xidmət adı daxil edin">
              	  </div>
                </div>
             ...
             <div class="col-md-12"> 	       		
             	 <div  class="form-group col-md-6">
                 	 <label>Xidmət haqqı</label>
                    	<input class="form-control" type="text" name="xidmet_haqqi" <?php if($_GET['saxlandi']=='ok'){ ?> value="<?php echo $xidmet_cek['xidmet_haqqi'] ?>" <?php } ?> required="" placeholder="AZN">
              	  </div>
                </div>
          ...
          <div style="margin-left:370px;" class="col-md-6">  
            <div class="form-group col-md-3">
                   <input style="width:100%" class="btn btn-success" type="submit" name="xidmet-elave" value="Əlavə et">
            </div>
          </div>
