...
@NamedQueries({
        ...
        @NamedQuery(name = "EmploymentHistory.findAllEmploymentHistoryByUserId", query = "SELECT e FROM EmploymentHistory e WHERE e.user.id = :userId"),
...
public class EmploymentHistory implements Serializable {
    ...
    public EmploymentHistory(Integer id, String jobDescription) {
        this.id = id;
